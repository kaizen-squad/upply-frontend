...
const Task: FC<TaskProps> = ({id, client_id, prestataire_id, title, description, budget, deadline, status}) => {
    const flagColor ={
  ...
  return (
    <div className="bg-white-solid border-2 border-gray-200 shadow-2xs w-[280px] rounded-sm m-10">
        <div className="p-5">
        ...
        <div className="py-4 bg-gallery-gray-93 rounded-b-xs">
            <button className="block w-[85%] m-auto py-2.5 bg-woodsmoke-gray-10 text-white-solid rounded-sm">Voir la tâche</button>
        </div>
    </div>
  )
}
