...
import FlagApplication from '../prestataire/FlagApplication';
    ...
    <div className="md:flex justify-between gap-5 bg-white-solid rounded-sm p-5 border py-10">
        <div className="flex gap-4">
            ...
            <div>
                ...
                {!isMobile && <p className="text-scarpa-flow-gray-34 mt-3 rotate-[0.5deg]">{application.message}</p>}
            </div>                
        </div>            
        {isMobile && <p className="text-scarpa-flow-gray-34 mt-3 rotate-[0.5deg]">{application.message}</p>}

        {
            ...
            :
            <div className="mt-3 md:mt-0"><FlagApplication status={application.status} /></div>
